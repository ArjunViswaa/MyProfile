...
function ProfileAndEducation({ bgScreenSet }) {
    return (
        <div id="projects-and-Education" className='flex flex-col gap-4 order-2 md:order-1'>
            <div onClick={() => bgScreenSet(true)} className="bg-[#18181b] text-white p-6 rounded-lg flex flex-col items-center h-[45vh] cursor-pointer transition-transform duration-500 hover:!scale-105">
