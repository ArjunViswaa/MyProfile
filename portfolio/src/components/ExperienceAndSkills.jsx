        ...
        <div id="profile-experience-skills" className='flex flex-col gap-4 md:col-span-2 order-1 md:order-2'>
            <div className='flex flex-row gap-2 flex-1 max-h-[25vh]'>
                <div className='w-[50%] mr-3 rounded-lg bg-[#9353d3] cursor-pointer transition-transform duration-500 hover:!scale-105'>
                    ...
                    <h5 className="text-xl font-bold text-white mt-[7%] ml-[5%]">Arjun S Viswanath</h5>
                </div>
                <div className='w-[50%] bg-[#006fee] rounded-lg cursor-pointer transition-transform duration-500 hover:!scale-105'>
                    ...
                    <h5 className="text-xl font-bold text-white mt-[7%] ml-[5%]">Software Associate - Projects</h5>
                </div>
            </div>
            ...
            <div className='flex flex-row gap-2 flex-1 max-h-[20vh]'>
                <div className='w-[50%] mr-3 rounded-lg bg-[#17c964] cursor-pointer transition-transform duration-500 hover:!scale-105'>
                    ...
                    <div className="flex flex-row w-full items-center justify-center flex-1 mt-2 mb-2">
