...
function ExperienceAndSkills({ setModal }) {
    return (
        <div id="profile-experience-skills" className='flex flex-col gap-4 md:col-span-2 order-1 md:order-2'>
            <div className='flex flex-row gap-2 flex-1 max-h-[25vh]'>
                <div onClick={() => setModal("personal")} className='w-[50%] mr-3 rounded-lg bg-[#9353d3] cursor-pointer transition-transform duration-500 hover:!scale-105'>
            ...
            <div className='flex flex-row gap-2 flex-1 max-h-[20vh]'>
                <div onClick={() => setModal("experience")} className='w-[50%] mr-3 rounded-lg bg-[#17c964] cursor-pointer transition-transform duration-500 hover:!scale-105'>
                ...
                <div onClick={() => setModal("skillsets")} className='w-[50%] bg-[#f5a524] rounded-lg cursor-pointer transition-transform duration-500 hover:!scale-105'>
